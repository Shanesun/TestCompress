...
class PhotoFilterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        photoFilterCollectionView.register(PhotoFilterCollectionViewCell.self, forCellWithReuseIdentifier: "PhotoFilterCell")
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        filteredImageView.filter = filters[(indexPath as NSIndexPath).item]
    }
}
